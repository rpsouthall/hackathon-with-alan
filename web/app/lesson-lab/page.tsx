...
export default function LessonLab() {
  ...
  return <main className="lesson-lab">
    <a href="/" className="lesson-back">← Back to Kyoto</a>
    <span className="lesson-kicker">KYOTO CONVERSATIONS</span><h1>Your next conversation<br />starts here.</h1><p>Everyday places. Ten small steps.<br />Speak English, discover Japanese, and learn as you go.</p>
