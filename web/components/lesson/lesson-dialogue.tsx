      ...
      <div className="lesson-content-column">
        ...
        {lesson.completed ? <div className="lesson-complete">
          ...
          {lesson.feedback && <article className={`lesson-feedback ${lesson.feedback.verdict}`} aria-live="polite">
            ...
            {lesson.feedback.verdict !== 'correct' && <div className="lesson-retry-phrase"><span className="lesson-kicker">YOU SAY BACK · TRY THIS ANSWER</span><p className="lesson-feedback-fix">“{question.options ? lesson.feedback.meaning : question.answerMeaning}”</p><p lang="ja">{lesson.feedback.japanese}</p></div>}
