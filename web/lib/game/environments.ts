...
export const conversationEnvironments: ConversationEnvironment[] = [
  {
    id: 'cafe', npcId: 'cafe_owner', worldNpcId: 'cafe_owner', title: 'A coffee in Kyoto', japanese: '喫茶店',
    category: 'Coffee shop', host: 'Aoi', image: '/environments/kyoto-cafe-v1.png',
  ...
  {
    id: 'fruit-market', npcId: 'shopkeeper', worldNpcId: 'market_produce', title: 'Something fresh from the market', japanese: '果物屋',
    category: 'Fruit market', host: 'Yui', image: '/environments/kyoto-fruit-market-v1.png',
  ...
  {
    id: 'restaurant', npcId: 'local_guide', worldNpcId: 'restaurant_momiji_host', title: 'A table for one, please', japanese: '食事処',
    category: 'Restaurant', host: 'Koharu', image: '/environments/kyoto-restaurant-v1.png',
